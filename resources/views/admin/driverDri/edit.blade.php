                            ...
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{ url('admin/assets/media/svg/avatars/blank.svg') }}')">
                                            ...
                                            <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ url('images/loadmaster/driver/'.$objs->avatar) }})"></div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="name" class="form-control form-control-lg form-control-solid" placeholder="ชื่อ - นามสกุล" value="{{ $objs->name }}">
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">รหัสพนักงาน </label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="code_user"  class="form-control form-control-lg form-control-solid" placeholder="ชื่อ - นามสกุล" value="{{ $objs->code_user }}" >
                                    </div>
                                    <!--end::Col-->
                                </div>
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">เลขทะเบียนรถ</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="no_car" class="form-control form-control-lg form-control-solid" placeholder="กด 5526 ง" value="{{ $objs->no_car }}">

                                        @if ($errors->has('no_car'))
                                            <div class="fv-plugins-message-container invalid-feedback">
                                                <div>{{ $errors->first('no_car') }}</div>
                                            </div>
                                        @endif
                                    </div>
                                    <!--end::Col-->
