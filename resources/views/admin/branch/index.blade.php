                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">รายชื่อสาขาลูกค้าทั้งหมด</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">สาขา ทั้งหมด </span>
                        ...
                        <div class="card-body py-3">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle gs-0 gy-3">
                                    ...
                                    <thead>
                                        <tr>
                                            <th class="p-0 ">ชื่อร้าน</th>
                                            <th class="p-0 ">ที่อยู่</th>
                                            <th class="p-0 ">ผู้ดูแล</th>
                                        ...
                                        <tr id="{{$item->id}}">
                                            ...
                                            <td>
                                                <div class="d-flex flex-column">
                                                    <a href="#" class="text-dark text-hover-primary fs-6 fw-bold">{{ $item->name_branch }}</a>
                                                    <a href="#" class="text-muted text-hover-primary fw-semibold text-muted d-block fs-7">
                                                        <span class="text-dark">รหัสสาขา </span>: {{ $item->code_branch }}
                                                    </a>
                                                </div>
                                            </td>
                                            <td>
