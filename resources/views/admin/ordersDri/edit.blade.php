                        ...
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <select class="form-select" name="cus_id" disabled="true">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <select class="form-select" id="branchSelect" name="branch_id" disabled="true">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <select class="form-select" id="driverSelect" name="province2" disabled="true">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        ...
                                        readonly>{{ $objs->b_address }}</textarea>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        ...
                                        class="form-control form-control-lg form-control-solid" placeholder="b_recive_name" value="{{ $objs->b_recive_name }}" readonly>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <div id="map_canvas" style="width:100%; border:0; height:516px;" frameborder="0">
                                         ...
                                         <div class="row">
                                        <div class="col-md-6">
                                            <input type="text" class="form-control form-control-lg form-control-solid" id="latitude" name="latitude" value="" readonly>
                                        </div>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control form-control-lg form-control-solid" id="longitude" name="longitude" value="" readonly>
                                        </div>
                                ...
                                <div class="row mb-6">
                                 ...
                                 <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="amount" class="form-control form-control-lg form-control-solid" value="{{ $objs->amount }}" readonly>
                                    </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <select class="form-select form-select-sm form-select-solid" disabled="true" name="typeService[]" data-control="select2" data-close-on-select="false" data-placeholder="Select an option" data-allow-clear="true" multiple="multiple">
                                            <option></option>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <select class="form-select" aria-label="Select example" name="sizepro" disabled="true">
                                            <option value="S"
                                            @if( $objs->size == "S")
                                                selected='selected'
                                                @endif
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label fw-semibold fs-6">ระบุจำนวนวาฟเฟิล </label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="waffles" class="form-control form-control-lg form-control-solid" value="{{ $objs->waffles }}" readonly>
                                    </div>
                                    <!--end::Col-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="machinery" class="form-control form-control-lg form-control-solid" value="{{ $objs->machinery }}" readonly>
                                    </div>
                                    <!--end::Col-->
