                    ...
                    <form id="kt_account_profile_details_form" class="form" method="POST" action="{{$url}}" enctype="multipart/form-data">
                        ...
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{ url('admin/assets/media/svg/avatars/blank.svg') }}')">
                                            ...
                                            <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ url('admin/assets/media/avatars/'.$objs->avatar) }})"></div>
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">รหัสสมาชิก </label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text"  class="form-control form-control-lg form-control-solid" placeholder="ชื่อ - นามสกุล" value="{{ $objs->code_user }}" readonly>
                                    </div>
                                    <!--end::Col-->
                                </div>
