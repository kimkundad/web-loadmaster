                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">สร้าง ราคาขนส่ง</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                            ...
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="province" class="form-control form-control-lg form-control-solid" placeholder="กรุงเทพมหานคร" value="{{old('province') ? old('province') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="tenbox"  class="form-control form-control-lg form-control-solid" placeholder="20" value="{{old('tenbox') ? old('tenbox') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="twentybox"  class="form-control form-control-lg form-control-solid" placeholder="20" value="{{old('twentybox') ? old('twentybox') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="thirtybox"  class="form-control form-control-lg form-control-solid" placeholder="20" value="{{old('thirtybox') ? old('thirtybox') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="fortybox"  class="form-control form-control-lg form-control-solid" placeholder="20" value="{{old('fortybox') ? old('fortybox') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="fiftybox"  class="form-control form-control-lg form-control-solid" placeholder="20" value="{{old('fiftybox') ? old('fiftybox') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="sixtybox"  class="form-control form-control-lg form-control-solid" placeholder="20" value="{{old('sixtybox') ? old('sixtybox') : ''}}">
