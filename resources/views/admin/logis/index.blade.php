                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">ราคาค่าขนส่งจังหวัด</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        <a href="{{ url('admin/logis/create') }}" class="btn btn-sm fw-bold btn-primary" >
                                ...
                                <table class="table align-middle gs-0 gy-3">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="p-0 ">10 กล่อง</th>
                                            <th class="p-0 ">20 กล่อง</th>
                                            <th class="p-0 ">30 กล่อง</th>
                                            <th class="p-0 ">40 กล่อง</th>
                                            <th class="p-0 ">50 กล่อง</th>
                                            <th class="p-0 ">60 กล่อง</th>
                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                            ...
                                            <td>
                                                <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ $item->province }}</a>
                                            </td>
                                            <td>
                                                {{ $item->tenbox }}
                                            </td>
                                            ...
                                            <td class="text-end">
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                    <a href="{{url('admin/logis/'.$item->id.'/edit')}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                    ...
                                                    <a href="{{ url('api/del_logis/'.$item->id) }}" onclick="return confirm('Are you sure?')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
...
<script type="text/javascript">
    $(document).ready(function(){
      $("input:checkbox").change(function() {
        ...
        $.ajax({
                type:'POST',
                url:'{{url('api/api_post_status_logis')}}',
